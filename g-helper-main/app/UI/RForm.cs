...
namespace GHelper.UI
{
    public class RForm : Form
    {
        ...
        public static Color colorEco = Color.FromArgb(255, 58, 174, 239); // Blue/Cyan for Silent mode
        public static Color colorStandard = Color.FromArgb(255, 168, 168, 168); // Gray/White for Balanced mode
        public static Color colorTurbo = Color.FromArgb(255, 255, 32, 32);
        public static Color colorCustom = Color.FromArgb(255, 255, 128, 0);
        public static Color colorGodMode = Color.FromArgb(255, 138, 43, 226); // Purple for Custom/GodMode
